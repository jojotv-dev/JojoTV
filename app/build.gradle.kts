...
fun resolveLocalSecret(local: Properties, key: String, fallback: String = ""): String {
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "TRAKT_CLIENT_ID", buildConfigString(resolveLocalSecret(localProperties, "TRAKT_CLIENT_ID")))

        buildConfigField("String", "TRAKT_CLIENT_SECRET", buildConfigString(resolveLocalSecret(localProperties, "TRAKT_CLIENT_SECRET")))

        buildConfigField("String", "TRAKT_API_URL", buildConfigString(resolveLocalSecret(localProperties, "TRAKT_API_URL", "https://api.trakt.tv/")))

        buildConfigField("String", "TRAKT_REDIRECT_URI", buildConfigString(resolveLocalSecret(localProperties, "TRAKT_REDIRECT_URI", "urn:ietf:wg:oauth:2.0:oob")))
        ...
        buildConfigField("String", "GITHUB_REPO", "\"JojoTV\"")
    ...
    splits {
        ...
        abi {
            ...
            isEnable = !buildingAppBundle && !isDebugTask
...
androidComponents {
    ...
    onVariants(selector().withBuildType("debug")) { variant ->
        ...
        variant.applicationId.set("com.jojo.tv")
...
// Globally exclude stock media3-exoplayer and media3-ui ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â replaced by the
...
dependencies {
    ...
    // - lib-exoplayer-release.aar    ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Custom forked ExoPlayer core (replaces media3-exoplayer)

    // - lib-ui-release.aar           ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Custom forked ExoPlayer UI

    // - lib-decoder-av1-release.aar  ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â AV1 software video decoder (libgav1)

    // - lib-decoder-iamf-release.aar ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â IAMF immersive audio decoder

    // - lib-decoder-mpegh-release.aar ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â MPEG-H 3D audio decoder
    ...
    implementation(project(":streamvault-data"))
